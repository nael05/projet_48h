...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-connect:hover { background: #0d9488; }
    ...
    .btn-register:hover { background: rgba(13,148,136,.06); }
...
<div class="page">
  ...
  <div class="panel-left">
    ...
    <p class="tagline">Le réseau social du campus Paris Ynov</p>
  </div>
  ...
  <div class="panel-right">
    ...
    <form class="form" action="/login" method="POST">
      ...
      <a href="/register">
        <button type="button" class="btn-register">Inscription</button>
      </a>
